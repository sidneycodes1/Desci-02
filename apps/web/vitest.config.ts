...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      '@sciagent/shared/supabase': path.resolve(__dirname, '../../packages/shared/supabase/index.ts'),
      '@sciagent/shared/supabase/server': path.resolve(__dirname, '../../packages/shared/supabase/server.ts'),
